      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='flex items-center gap-2 w-full'>
          <label htmlFor="car-image">
            <img src={image ? URL.createObjectURL(image) : assets.upload_icon} alt="upload icon" 
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type="text" placeholder='e.g. X5, G-Class...' required
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            <label>Daily Price ({currancy})</label>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <input type="number" placeholder='4' required min={2}
        ...
        <div className='flex flex-col w-full'>
          ...
          <button className='flex items-center gap-2 px-4 py-2.5 mt-4 bg-primary text-white rounded-md font-medium cursor-pointer'>
            <img src={assets.tick_icon} alt="ticlk icon" />
            List Your Car
          </button>
      </form>
