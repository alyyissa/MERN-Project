  ...
  return (
    <div>
      <div className='flex flex-col items-center py-20 bg-light max-md:px-4'>
        <Title title='Available Cars' subTitle='Browse through our selection of premium vehicles available for your next trip'/>
        ...
        rounded-full shadow'>
          ...
          <input onClick={(e)=> setInput(e.target.value)} value={input} type="text" placeholder='Search by Brand, or features' className='w-full
          h-full outline-none text-gray-500'/>
