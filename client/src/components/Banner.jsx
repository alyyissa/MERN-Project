  ...
  return (
    ...
    max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
        ...
        <div className='text-white'>
            ...
            <p className='mt-2'>Monetize ypur vehicle with no fees by listing it on CarRental.</p>
            <p className='max-x-130'>We take care of insurance, driver verification and secure payments — 
